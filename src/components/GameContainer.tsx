...
export function GameContainer() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#d4d4d8] p-8 font-sans flex flex-col justify-between selection:bg-[#c2410c]">
      <div className="space-y-16">
        <div className="flex justify-between items-end border-b border-[#1c1c1f] pb-6">
          ...
          <div className="flex flex-col items-end">
            <span className="text-[10px] text-[#3f3f46] uppercase tracking-widest mb-1">Node</span>
        ...
        <div className="space-y-8 max-w-lg">
          ...
          <p className="text-lg text-[#71717a] leading-relaxed font-light italic">{currentEvent?.narrative || "The world is silent as your story prepares to unfold."}</p>
        </div>
      </div>
