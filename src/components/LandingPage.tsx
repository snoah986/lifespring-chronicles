    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-[#c2410c] flex flex-col items-center justify-center font-mono p-10">
        <div className="w-full max-w-xs space-y-8">
          <div className="text-[10px] tracking-[0.4em] uppercase opacity-40 text-center animate-pulse">Neural Sync In Progress</div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#d4d4d8] flex flex-col justify-between p-12 font-serif overflow-hidden">
      <div className="flex justify-between items-start">
        <div className="text-[9px] tracking-[0.4em] text-[#3f3f46] uppercase leading-relaxed">Multi-Agency Extraction // v5.0 <br/> Wembley Node Active</div>
      ...
      <div className="relative">
        ...
        <p className="text-[10px] text-[#52525b] font-sans tracking-[0.3em] uppercase mt-8 leading-loose italic">A world built on echoes and extraction.</p>
      </div>
      ...
      <div className="fixed right-12 bottom-32 origin-bottom-right -rotate-90 text-[8px] tracking-[0.6em] text-[#18181b] uppercase whitespace-nowrap">Black Swan: 2.5% // Wembley_Extraction_Tactical</div>
    </div>
  );
}
